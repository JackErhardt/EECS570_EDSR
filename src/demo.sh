...
# python3 main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset
python3 char.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset
